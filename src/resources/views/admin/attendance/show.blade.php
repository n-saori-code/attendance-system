            ...
            <div class="attendance__form-item">
                ...
                <div class="attendance__form-inner">
                    <div class="attendance__form-wrap">
                        ...
                        @else
                        <input class="form__date" type="text" name="clock_in"
                            value="{{ old('clock_in', $attendance->clock_in?->format('H:i')) }}">
                        <span>〜</span>
                        <input class="form__date" type="text" name="clock_out"
            ...
            <div class="attendance__form-item">
                ...
                <div class="attendance__form-inner">
                    <div class="attendance__form-wrap">
                        ...
                        @else
                        <input class="form__date" type="text" name="break_start[0]"
                            value="{{ old('break_start.0', $breaks->get(0)?->break_start?->format('H:i')) }}">
                        <span>〜</span>
                        <input class="form__date" type="text" name="break_end[0]"
                            value="{{ old('break_end.0', $breaks->get(0)?->break_end?->format('H:i')) }}">
                        @endif
                    </div>
            ...
            <div class="attendance__form-item">
                ...
                <div class="attendance__form-inner">
                    <div class="attendance__form-wrap">
                        ...
                        @else
                        <input class="form__date" type="text" name="break_start[1]"
                            value="{{ old('break_start.1', $breaks->get(1)?->break_start?->format('H:i')) }}">
                        <span>〜</span>
                        <input class="form__date" type="text" name="break_end[1]"
                            value="{{ old('break_end.1', $breaks->get(1)?->break_end?->format('H:i')) }}">
                        @endif
                    </div>
            ...
            <div class="attendance__form-item">
                ...
                <div class="attendance__form-inner">
                    ...
                    <div class="attendance__form-wrap">
                        ...
                        @else
                        <input class="form__date" type="text"
                            name="break_start[{{ $fieldIndex }}]"
                            value="{{ old("break_start.$fieldIndex", $break->break_start?->format('H:i')) }}">
                        <span>〜</span>
                        <input class="form__date" type="text"
                            name="break_end[{{ $fieldIndex }}]"
                            value="{{ old("break_end.$fieldIndex", $break->break_end?->format('H:i')) }}">
                        @endif
                    </div>
            ...
            <div class="attendance__form-item">
                ...
                <div class="attendance__form-inner">
                    ...
                    <div class="attendance__form-wrap">
                        ...
                        @else
                        <input class="form__date" type="text"
                            name="break_start[{{ $newIndex }}]"
                            value="{{ old("break_start.$newIndex") }}">
                        <span>〜</span>
                        <input class="form__date" type="text"
                            name="break_end[{{ $newIndex }}]"
